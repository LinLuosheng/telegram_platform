...
win:
    "C:\\Program Files\\Python310\\python.exe" -m venv python
    python\\Scripts\\python.exe -m pip install pywin32 six meson
""", 'ThirdParty')
...
if 'build-stackwalk' in options:
    stage('stackwalk', """
mac:
    git clone https://github.com/google/breakpad stackwalk
    cd stackwalk
...
depends:patches/breakpad.diff
    ...
    git clone https://github.com/getsentry/linux-syscall-support src/third_party/lss
