...
public class CodeGenerator {
    ...
    public static void main(String[] args) throws TemplateException, IOException {
        generate("com.yupi.springbootinit", "C2设备", "c2Device", "C2Device");
        generate("com.yupi.springbootinit", "C2任务", "c2Task", "C2Task");
    }

    public static void generate(String packageName, String dataName, String dataKey, String upperDataKey) throws TemplateException, IOException {
        // 封装生成参数
        ...
        outputPath = String.format("%s/generator/%s/controller/%sController.java", projectPath, upperDataKey, upperDataKey);
        // 生成
        ...
        outputPath = String.format("%s/generator/%s/service/%sService.java", projectPath, upperDataKey, upperDataKey);
        doGenerate(inputPath, outputPath, dataModel);
        ...
        outputPath = String.format("%s/generator/%s/service/impl/%sServiceImpl.java", projectPath, upperDataKey, upperDataKey);
        doGenerate(inputPath, outputPath, dataModel);
        ...
        outputPath = String.format("%s/generator/%s/model/dto/%sAddRequest.java", projectPath, upperDataKey, upperDataKey);
        doGenerate(inputPath, outputPath, dataModel);
        inputPath = projectPath + File.separator + "src/main/resources/templates/model/TemplateQueryRequest.java.ftl";
        outputPath = String.format("%s/generator/%s/model/dto/%sQueryRequest.java", projectPath, upperDataKey, upperDataKey);
        doGenerate(inputPath, outputPath, dataModel);
        inputPath = projectPath + File.separator + "src/main/resources/templates/model/TemplateEditRequest.java.ftl";
        outputPath = String.format("%s/generator/%s/model/dto/%sEditRequest.java", projectPath, upperDataKey, upperDataKey);
        doGenerate(inputPath, outputPath, dataModel);
        inputPath = projectPath + File.separator + "src/main/resources/templates/model/TemplateUpdateRequest.java.ftl";
        outputPath = String.format("%s/generator/%s/model/dto/%sUpdateRequest.java", projectPath, upperDataKey, upperDataKey);
        doGenerate(inputPath, outputPath, dataModel);
        ...
        outputPath = String.format("%s/generator/%s/model/vo/%sVO.java", projectPath, upperDataKey, upperDataKey);
        doGenerate(inputPath, outputPath, dataModel);
